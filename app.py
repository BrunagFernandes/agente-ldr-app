# --- VERSÃO COM LÓGICA DE ANÁLISE ONLINE RESTAURADA E CORRIGIDA ---
    ...
    if arquivo_dados and arquivo_icp:
        ...
        if leads_df is not None and icp_raw_df is not None:
            ...
            for index, lead in leads_df.iterrows():
                ...
                # --- LÓGICA DE QUALIFICAÇÃO E ANÁLISE COMPLETA ---
                
                analise = None
                
                # 1. Filtros Locais Rígidos
                ...
                # 2. Análise da Empresa (com Plano B)
                ...
                # 3. Preenchimento do Resultado Final
                if analise and "error" not in analise:
            ...
            # --- Aplicação da Padronização Final ---
